...
if has("python")
python << EOL
def sage_current_doctest_tmux_writer(line1, line2, pane_id):
    r"""
    Paste a sage doctest into a tmux pane.
...
command! -nargs=? -range -complete=custom,tbone#complete_panes SageFunctionDoctestTwrite
    \ execute ":python sage_doctest_tmux_writer(<line1>, <line2>, \"<args>\")"

nnoremap <LocalLeader>sf :SageFunctionDoctestTwrite<CR>
vnoremap <LocalLeader>sf :SageFunctionDoctestTwrite<CR>
